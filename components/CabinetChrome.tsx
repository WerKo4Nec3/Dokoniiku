...
export function CabinetChrome() {
  ...
  return (
    <div className="fixed inset-x-0 top-16 z-40 border-b border-black/5 bg-[color:color-mix(in_srgb,var(--background)_80%,transparent)] backdrop-blur-xl dark:border-white/10">
